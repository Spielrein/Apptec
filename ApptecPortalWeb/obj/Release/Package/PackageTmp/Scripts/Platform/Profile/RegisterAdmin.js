...
function InstirutionRegisterUser() {
    ...
    $.ajax({
        ...
        "cache": false,
        "method": "POST",
        "url": "http://192.168.32.104:59461/Api/Institution/UpdateRegisterUser",
...
function AdminPortal() {
    ...
    $.ajax({
        ...
        "cache": false,
        "method": "POST",
        "url": "http://192.168.32.104:59461/Api/Admin/Create",
        "data": JSON.stringify(oModel),
        "contentType": "application/json"
...
function AdminApi() {
    ...
    $.ajax({
        ...
        "cache": false,
        "method": "POST",
        "url": "http://192.168.32.104:59461/api/accounts/create",
        "data": JSON.stringify(oModel),
        "contentType": "application/json"
