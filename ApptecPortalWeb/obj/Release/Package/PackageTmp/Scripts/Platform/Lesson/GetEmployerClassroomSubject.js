...
/*function LoadGroup() {
    ...
    $.ajax({
        url: "http://192.168.32.104:59461/Api/Lesson/ShowGroup",
        method: "POST",
        dataType: "json",
        data: "{}",
...
function LoadSubject() {
    ...
    var msj;
        ...
        $.ajax({
            url: "http://192.168.32.104:59461/Api/Lesson/ShowSubject",
            method: "POST",
            dataType: "json",
...
function LoadEmployer() {
    ...
    $.ajax({
        url: "http://192.168.32.104:59461/Api/Lesson/ShowEmployer",
        method: "POST",
        dataType: "json",
        data: JSON.stringify(oModel),
        success: function (data) {
...
function LoadClassroom() {
    ...
    $.ajax({
        url: "http://192.168.32.104:59461/Api/Lesson/ShowClassroom",
        method: "POST",
        dataType: "json",
        data: JSON.stringify(oModel),
        success: function (data) {
