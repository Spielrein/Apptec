...
namespace ApiRest.Controllers
{
    ...
    public class StudentController : ApiController
    {
        ...
        public IHttpActionResult Create([FromBody]StudentModel student)
        {
            ...
            var consulta = StudentData.Crear(student.Matricula, student.Nombre, student.Apellidop, student.Apellidom, student.Telefono, student.InstitucionId, student.GrupoId, student.Grado, student.User);
            return Ok(consulta);
        }
       ...
       /// <returns>Lista de tipo estudiantes</returns>
        [HttpPost]
        [Route("Show")]
        public IHttpActionResult Show(StudentModel student)
        {
            u = credenciales.getUsuario();
            c = credenciales.getUsuario();
            var consulta = StudentData.Mostrar(student.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult Update(StudentModel student)
        {
            u = credenciales.getUsuario();
            c = credenciales.getUsuario();
            var consulta = StudentData.Actualizar(student.StudentId, student.Matricula, student.Nombre, student.Apellidop, student.Apellidom, student.Telefono, student.InstitucionId, student.GrupoId, student.Grado,student.User);
            return Ok(consulta);
        }
        ...
        [HttpPost]
        [Route("ShowGroup")]
        public IHttpActionResult ShowGroup(StudentModel student)
        {
            u = credenciales.getUsuario();
            c = credenciales.getUsuario();
            var consulta = StudentData.ObtenerGroup(student.User);
            return Ok(consulta);
        }
        ...
        [HttpPost]
        [Route("ShowDegree")]
        public IHttpActionResult ShowDegree(StudentModel student)
        {
            u = credenciales.getUsuario();
            c = credenciales.getUsuario();
            var consulta = StudentData.ObtenerGrado(student.User);
            return Ok(consulta);
        }
    }
}
