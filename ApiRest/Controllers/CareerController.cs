...
namespace ApiRest.Controllers
{
    ...
    public class CareerController : ApiController
    {
        ...
        public IHttpActionResult Create([FromBody]CareerModel career)
        {
            ...
            var consulta = CareerData.Crear(career.Clave, career.Nombre, career.InstitucionId,career.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult Show([FromBody]CareerModel career)
        {
            ...
            var consulta = CareerData.Mostrar(career.User);
            return Ok(consulta);
        }
        ...
        {
            u = credenciales.getUsuario();
            var consulta = CareerData.Actualizar(career.CareerId, career.Clave, career.Nombre, career.InstitucionId, career.User);
            return Ok(consulta);
        }
