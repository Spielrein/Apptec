...
namespace ApiRest.Controllers
{
    ...
    public class SpecialityController : ApiController
    {
        ...
        public IHttpActionResult Create([FromBody]SpecialityModel speciality)
        {
            ...
            var consulta = SpecialityData.Crear(speciality.Nombre, speciality.InstitucionId,speciality.User);
            return Ok(consulta);
        }
        ...
        [HttpPost]
        [Route("Show")]
        public IHttpActionResult Show(SpecialityModel speciality)
        {
            u = credenciales.getUsuario();
            c = credenciales.getUsuario();

            var consulta = SpecialityData.Mostrar(speciality.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult Update(SpecialityModel speciality)
        {
            ...
            var consulta = SpecialityData.Actualizar(speciality.SpecialityId, speciality.Nombre, speciality.InstitucionId,speciality.User);
            return Ok(consulta);
        }
