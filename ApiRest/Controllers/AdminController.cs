...
namespace ApiRest.Controllers
{
    ...
    public class AdminController : ApiController
    {
        ...
        {
            u = credenciales.getUsuario();
            var consulta = AdminData.Mostrar(admin.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult ShowUser(AdminModel admin)
        {
            ...
            if(valido == true)
            {
                ...
                var consulta = AdminData.MostrarUser(admin.User);
                return Ok(consulta);
            }
            return NotFound();
        ...
        public IHttpActionResult UpdateRegister([FromBody]AdminModel admin)
        {
            ...
            u = credenciales.getUsuario();
            var consulta = AdminData.UpdateRegister(admin.AdminsID, admin.Name, admin.LastNameP, admin.LastNameM, nose, admin.User);
            return Ok(consulta);
        }
