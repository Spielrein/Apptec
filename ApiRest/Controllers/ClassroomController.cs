...
namespace ApiRest.Controllers
{
    ...
    public class ClassroomController : ApiController
    {
        ...
        public IHttpActionResult Create([FromBody]ClassroomModel classroom)
        {
            ...
            var consulta = ClassroomData.Crear(classroom.Clave,classroom.Nombre,classroom.Descripcion,classroom.Institucion,classroom.TipoAula,classroom.User);
            return Ok(consulta);
        }
        ...
        [HttpPost]
        [Route("Show")]
        public IHttpActionResult Show(ClassroomModel classroom)
        {
            u = credenciales.getUsuario();
            

            var consulta = ClassroomData.Mostrar(classroom.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult Update(ClassroomModel classroom)
        {
            ...
            var consulta = ClassroomData.Atualizar(classroom.ClassroomId, classroom.Clave, classroom.Nombre, classroom.Descripcion, classroom.Institucion, classroom.TipoAula,classroom.User);
            return Ok(consulta);
        }
        ...
        public IHttpActionResult ShowInstitution(UserModel user)
        {
            u = credenciales.getUsuario();
            var consulta = ClassroomData.ObtenerInstitucion(user.User);
            return Ok(consulta);
        }
    }
}
